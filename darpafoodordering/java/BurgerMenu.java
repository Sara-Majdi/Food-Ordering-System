...
public class BurgerMenu extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(BurgerMenu.this));

        FirebaseRecyclerOptions<MenuHelperClass> options =
                new FirebaseRecyclerOptions.Builder<MenuHelperClass>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Menu").orderByChild("foodtype").equalTo("Burger"), MenuHelperClass.class)
                        .build();
